package ru.mirea.vozhzhovea.httpurlconnection;
...
import ru.mirea.vozhzhovea.httpurlconnection.databinding.ActivityMainBinding;
        ...
        binding.button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (networkinfo != null && networkinfo.isConnected()) {
                    new DownloadPageTask().execute("https://ipinfo.io/json"); // запуск нового по- 2
                }
                else {
                    //Toast.makeText(this, "Нет интернета", Toast.LENGTH_SHORT).show();
                    binding.textViewIP.setText("Нет интернета");
                    binding.textViewCity.setText("Нет интернета");
                    binding.textViewCountry.setText("Нет интернета");
                    binding.textViewD.setText("Нет интернета");
                    binding.textViewS.setText("Нет интернета");
        ...
        binding.button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (networkinfo != null && networkinfo.isConnected()) {
                    ...
                    new DownloadPageTask2().execute(zap); // запуск нового по- 2
                }
                else {
                    binding.textView3.setText("Нет интернета");
    ...
    private class DownloadPageTask2 extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            try {
                ...
                binding.textView3.setText("Температура сейчас по Цельсию: " + temp);
            } catch (Exception e) {
                e.printStackTrace();
            }
            super.onPostExecute(result);
